...
def test_assignment_double_click_finds_assignment() -> None:
    _application()
    ...
    item = dialog._assignment_list.item(
        0
    )
...
def test_assignment_list_is_not_editable_directly() -> None:
    _application()
    ...
    assert (
        dialog._assignment_list.editTriggers()
        == dialog._assignment_list.EditTrigger.NoEditTriggers
    )