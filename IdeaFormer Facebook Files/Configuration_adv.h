...
// LCD Print Progress options
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         -1 // (was set to 44) Pin to detect power loss. Set to -1 to disable default pin on boards without module.
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.22    // (was set to 0 2022-12-04) Unit: mm compression per 1mm/s extruder speed
